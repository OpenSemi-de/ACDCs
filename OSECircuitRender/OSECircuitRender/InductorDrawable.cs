namespace OSECircuitRender
{
    public sealed class InductorDrawable : DrawableComponent
    {
        ...
        private void Setup(IWorksheetItem backRef, string value = "N/A", float x = 0, float y = 0)
        {
            ...
            DrawInstructions.Add(new Path("M 1,8.5 L 6.5,8.5 C 6.5,8.5 6.5,4.5 10.5,4.5 C 14.5,4.5 14.5,8.5 14.5,8.5 C 14.5,8.5 14.5,4.5 18.5,4.5 C 22.5,4.5 22.5,8.5 22.5,8.5 C 22.5,8.5 22.5,4.5 26.5,4.5 C 30.5,4.5 30.5,8.5 30.5,8.5 C 30.5,8.5 30.5,4.5 34.5,4.5 C 38.5,4.5 38.5,8.5 38.5,8.5 L 44,8.5"));
            SetSize(1, 3);
            SetPosition(x, y);
            SetRef(backRef);
        }
