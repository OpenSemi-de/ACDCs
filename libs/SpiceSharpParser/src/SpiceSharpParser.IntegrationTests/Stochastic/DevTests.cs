...
{
    public class DevTests : BaseTests
    {
        [Fact]
        public void DevMultipleComponentsSameModel()
        {
        ...
        public void DevZero()
        {
            ...
            var netlist = GetSpiceSharpModel(
                ...
                "D1 OUT 0 1N914",
                "V1 OUT 0 0",
                ".model 1N914 D(Is=2.52e-9 DEV 0% Rs=0.568 N=1.752 Cjo=4e-12 M=0.4 tt=20e-9)",
                ".DC V1 -1 1 10e-3",
                ".SAVE i(V1)",
                ".END");
        ...
        [Fact]
        public void DevNonZeroConstantWithExpression()
        {
            int randomSeed = 1234;
            var netlist = GetSpiceSharpModel(
                randomSeed,
                ...
                "D1 OUT 0 1N914",
                "V1 OUT 0 0",
                ".model 1N914 D(Is={2.52e-9 + 0 * 1} DEV 10% Rs=0.568 N=1.752 Cjo=4e-12 M=0.4 tt=20e-9)",
                ".DC V1 -1 1 0.1",
                ".SAVE i(V1)",
                ".END");
            var export = RunDCSimulation(netlist, "i(V1)");
        ...
        [Fact]
        public void DevNonZeroConstant()
        {
            int randomSeed = 1234;
            var netlist = GetSpiceSharpModel(
                randomSeed,
                ...
                "D1 OUT 0 1N914",
                "V1 OUT 0 0",
                ".model 1N914 D(Is=2.52e-9 DEV 10% Rs=0.568 N=1.752 Cjo=4e-12 M=0.4 tt=20e-9)",
                ".DC V1 -1 1 0.1",
                ".SAVE i(V1)",
                ".END");
            var export = RunDCSimulation(netlist, "i(V1)");
        ...
        [Fact]
        public void DevNonZeroConstantWithUniformDistribution()
        {
            int randomSeed = 1234;
            var netlist = GetSpiceSharpModel(
                randomSeed,
        ...
        [Fact]
        public void DevNonZeroConstantWithNonUniformDistribution()
        {
            int randomSeed = 1234;
            var netlist = GetSpiceSharpModel(
                randomSeed,
                ...
                "D1 OUT 0 1N914",
                "V1 OUT 0 0",
                ".model 1N914 D(Is=2.52e-9 DEV/triangle 10% Rs=0.568 N=1.752 Cjo=4e-12 M=0.4 tt=20e-9)",
                ".DC V1 -1 1 0.1",
                ".SAVE i(V1)",
                ".DISTRIBUTION triangle (-1,0) (0, 1) (1, 0)",
                ".END");
            var export = RunDCSimulation(netlist, "i(V1)");
            ...
            double[] references =
            {
                2.4938122678008767E-09,
                2.4935962184002847E-09,
                2.4933148878858447E-09,
                2.4929147635077697E-09,
                2.4922803820714989E-09,
                2.49112941386187E-09,
                2.4886517291378141E-09,
                2.4818745947285947E-09,
                2.4543447829650233E-09,
                2.2188558213009912E-09,
                 1.8392420952194342E-32,
                 -2.0161445235533648E-08,
                 -2.0336282957611473E-07,
                 -1.8680345229560302E-06,
                 -1.6991359924500848E-05,
                 -0.0001541516830380063,
                 -0.0013794138364595643,
                 -0.011096988663137575,
                 -0.056835938496004212,
                 -0.15358557557533326,
                 -0.28134908011458348
            };
        ...
        public void DevNonZeroParam()
        {
            ...
            var netlist = GetSpiceSharpModel(
                ...
                "D1 OUT 0 1N914",
                "V1 OUT 0 0",
                ".model 1N914 D(Is=2.52e-9 DEV x_percent Rs=0.568 N=1.752 Cjo=4e-12 M=0.4 tt=20e-9)",
                ".param x_percent = 10",
                ".DC V1 -1 1 0.1",
                ".SAVE i(V1)",
                ".END");
